...
<div class="ch-container">
	<div class="row">
		...
		<div id="content" class="col-lg-10 col-sm-10">
			...
			<div>
				<ul class="breadcrumb">
					<li><a href="../HomePage/HomeAdmin.jsp">Home</a></li>
					<li><a href="#">ElencoClienti</a></li>
				</ul>
			</div>
			<div class="row">
				...
				%>
									...
									<c:forEach items="${lista}" var="u">
										<tr>
											...
											<input type="hidden"
												value="${u.id_Utente}" name="id_Utente" />
												<button id="editCliente" type="button" class="btn btn-info">
